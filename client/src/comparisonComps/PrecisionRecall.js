        ...
        if(c===0)
            if(n_classes>2)
                ...
                trace.push({ 
                    ...
                    y: recall[i], 
                    type: 'scatter', 
                    name: evalList[i].data.dataset.name+'(AUC='+evalList[i].data.metadata.precision_recall_auc.toFixed(2)+')' 
                });
        else
            if(n_classes>2){
                trace.push({ 
                    ...
                    y: recall[i], 
                    type: 'scatter', 
                    name:evalList[i].data.name+'(AUC='+evalList[i].data.metadata.precision_recall_auc["micro"].toFixed(2)+')' ,
