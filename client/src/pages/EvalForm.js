...
export default function EvalForm(props) {
  ...
  return (
	<Grid container spacing={5} style={{alignItems:'center', justifyContent:'center',}}>
		...
		<Grid item xs={8} sm={4} style={{alignItems:'center', justifyContent:'center',}}>
			<Paper elevation={5} >
			<CssBaseline />
				<Grid container spacing={2} className={classes.paper}>
					<Grid item align="center" xs={12} sm={12} lg={12} style={{alignItems:'center', justifyContent:'center',}}>
						<Avatar className={classes.avatar} align="center">
							<PostAddIcon />
						</Avatar>
					</Grid>
					<Grid item xs={12} sm={12} lg={12} style={{alignItems:'center', justifyContent:'center',}}>
					...
					<Grid item xs={12}>
						<form className={classes.form} onSubmit={handleSubmit}>
							<Grid container spacing={2}>
								<Grid item xs={12} sm={12} lg={12} align="center" className={classes.formElements}>
									<TextField
										variant="outlined"
										margin="none"
										required
								...
								<Grid item xs={12} sm={12} lg={12} className={classes.formElements}>
